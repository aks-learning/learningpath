---
sidebar_position: 2
title: "az aks cheat sheet"
description: "Quick reference for Azure CLI commands to manage AKS clusters, node pools, upgrades, and add-ons."
---

# az aks cheat sheet

Every `az aks` command you need for cluster lifecycle, node pool management, upgrades, and add-on configuration. Copy, paste, modify the resource group and cluster name.
...
- [az aks nodepool Reference](https://learn.microsoft.com/en-us/cli/azure/aks/nodepool)
